...
func (m *MockInterface) GetStringMap(key string) map[string]interface{} {
	m.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) GetStringMap(key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStringMap", reflect.TypeOf((*MockInterface)(nil).GetStringMap), key)
}

// GetStringMapString mocks base method.
func (m *MockInterface) GetStringMapString(key string) map[string]string {
	m.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) GetStringMapString(key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStringMapString", reflect.TypeOf((*MockInterface)(nil).GetStringMapString), key)
}
